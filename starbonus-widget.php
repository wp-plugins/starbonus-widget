    ...
    final class StarBonusPlugin
    {
        ...
        private function init_hooks()
        {
            ...
            register_deactivation_hook( __FILE__,
                                        [ $this, 'starbonus_widget_cron_retry_older_transaction_deactivation' ] );
...
//        $entity->setCategory('');
        ...
        public function createTransactionCashback( $order, $clickId )
        {
            ...
            $entity = new \Starbonus\Api\Entity\TransactionCashback();
            $entity->setTransaction( 'wordpress-' . $order->get_order_number() )->setClick( $clickId )->setAmountPurchase( ( $order->get_total() - ( get_option( 'starbonus_shipping_cost' ) ? $order->get_total_shipping() : 0 ) ) * 100 )->setCurrency( $order->get_order_currency() )->setState( 'pending' );
//            ->setCategory('');
        ...
        public function starbonus_menu_page()
        {
            add_menu_page( 'StarBonus', 'StarBonus', 'manage_options', 'starbonus-menu',
                           [ $this, 'starbonus_menu_main' ], plugins_url( '/starbonus-widget/assets/images/logo.png' ) );
        }
				...
				<div class="form-field form-required term-name-wrap">
				    <form action="' . $_SERVER['REQUEST_URI'] . '" method="post">
					    <div>
						    ...
						    <input type="text" placeholder="np. nazwasklepu" style="width:99%" name="client_id" value="' . ( isset( $_POST['client_id'] ) ? $clientId : ( get_option( 'starbonus_client_id' ) ? get_option( 'starbonus_client_id' ) : null ) ) . '" size="40" aria-required="true">
					    ...
					    <div>
						    ...
						    <input type="text" placeholder="np. TajneHaslo123" style="width:99%" name="client_password" value="' . ( isset( $_POST['client_password'] ) ? $clientPassword : ( get_option( 'starbonus_client_password' ) ? get_option( 'starbonus_client_password' ) : null ) ) . '" size="40" aria-required="true">
					    ...
					    <div>
						    ...
						    <input type="number" placeholder="np. 123" style="width:99%" name="program_id" value="' . ( isset( $_POST['program_id'] ) ? $programId : ( get_option( 'starbonus_program_id' ) ? get_option( 'starbonus_program_id' ) : null ) ) . '" size="40" aria-required="true">
					    ...
					    <div>
						    ...
						    <input type="number" placeholder="np. 99" style="width:99%" name="bonus_id" value="' . ( isset( $_POST['bonus_id'] ) ? $bonusId : ( get_option( 'starbonus_bonus_id' ) ? get_option( 'starbonus_bonus_id' ) : null ) ) . '" size="40" aria-required="true">
					    ...
					    <div>
						    ...
						    <input type="text" placeholder="np. nazwasklepu.pl" style="width:99%" name="source" value="' . ( isset( $_POST['source'] ) ? $source : ( get_option( 'starbonus_source' ) ? get_option( 'starbonus_source' ) : null ) ) . '" size="40">
					    ...
					    <div>
						    ...
						    <input type="number" placeholder="np. 17" style="width:99%" name="order_timestamp_limit" value="' . ( isset( $_POST['order_timestamp_limit'] ) ? $orderTimestampLimit : ( get_option( 'starbonus_order_timestamp_limit' ) ? get_option( 'starbonus_order_timestamp_limit' ) : null ) ) . '" size="40">
					    ...
					    <div>
                            ...
                            <select name="open_widget" style="width:99%">
                                <option value="disable" ' . ( get_option( 'starbonus_open_widget' ) === 'disable' ? 'selected' : false ) . '>Wyłącz</option>
                                <option value="ever" ' . ( get_option( 'starbonus_open_widget' ) === 'ever' ? 'selected' : false ) . '>Włącz dla wszystkich</option>
                                <option value="redirect" ' . ( get_option( 'starbonus_open_widget' ) === 'redirect' ? 'selected' : false ) . '>Włącz tylko dla Klientów przekierowanych ze StarBonus</option>
                            </select>
					    ...
					    <div>
                            ...
                            <select name="url_api" style="width:99%">
                                <option value="production" ' . ( get_option( 'starbonus_url_api' ) === 'production' ? 'selected' : false ) . '>Produkcja</option>
                                <option value="test" ' . ( get_option( 'starbonus_url_api' ) === 'test' ? 'selected' : false ) . '>Testowa</option>
                            </select>
					    ...
					    <div>
						    ...
						    <input type="checkbox" name="expanded" ' . ( ( ( isset( $_POST['expanded'] ) && $expanded ) || ( ! isset( $_POST['expanded'] ) && get_option( 'starbonus_expanded' ) ) ) ? 'checked="checked"' : ( get_option( 'starbonus_expanded' ) ? get_option( 'starbonus_expanded' ) : false ) ) . '>
					    ...
					    <div>
						    ...
						    <input type="number" placeholder="np. 600" style="width:99%" name="min_width" value="' . ( isset( $_POST['min_width'] ) ? $minWidth : ( get_option( 'starbonus_min_width' ) ? get_option( 'starbonus_min_width' ) : null ) ) . '" size="40">
					    ...
					    <div>
						    ...
						    <input type="number" placeholder="np. 150" style="width:99%" name="widget_below" value="' . ( isset( $_POST['widget_below'] ) ? $widgetBelow : ( get_option( 'starbonus_widget_below' ) ? get_option( 'starbonus_widget_below' ) : null ) ) . '" size="40">
					    ...
					    <div>
                            ...
                            <select name="widget_side" style="width:99%">
                                <option value="left" ' . ( get_option( 'starbonus_widget_side' ) === 'left' ? 'selected' : false ) . '>Lewa</option>
                                <option value="right" ' . ( get_option( 'starbonus_widget_side' ) === 'right' ? 'selected' : false ) . '>Prawa</option>
                            </select>
					    ...
					    <div>
                            ...
                            <select name="skin" style="width:99%">
                                <option value="violet" ' . ( get_option( 'starbonus_skin' ) === 'violet' ? 'selected' : false ) . '>Fiolet</option>
                                <option value="orange" ' . ( get_option( 'starbonus_skin' ) === 'orange' ? 'selected' : false ) . '>Pomarańcz</option>
                                <option value="red" ' . ( get_option( 'starbonus_skin' ) === 'red' ? 'selected' : false ) . '>Czerwień</option>
                                <option value="green" ' . ( get_option( 'starbonus_skin' ) === 'green' ? 'selected' : false ) . '>Zieleń</option>
                                <option value="grey" ' . ( get_option( 'starbonus_skin' ) === 'grey' ? 'selected' : false ) . '>Szarość</option>
                            </select>
					    ...
					    <div>
						    ...
						    <input type="checkbox" name="animation" ' . ( ( ( isset( $_POST['animation'] ) && $animation ) || ( ! isset( $_POST['animation'] ) && get_option( 'starbonus_animation' ) ) ) ? 'checked="checked"' : ( get_option( 'starbonus_animation' ) ? get_option( 'starbonus_animation' ) : false ) ) . '>
    ...
    ';
        ...
        {
            global $reg_errors, $clientId, $clientPassword, $programId, $bonusId, $openWidget, $urlApi, $orderTimestampLimit, $source, $shippingCost, $expanded, $minWidth, $widgetBelow, $widgetSide, $skin, $animation;
        ...
        {
            global $clientId, $clientPassword, $programId, $bonusId, $openWidget, $urlApi, $orderTimestampLimit, $source, $shippingCost, $expanded, $minWidth, $widgetBelow, $widgetSide, $skin, $animation;
            if ( isset( $_POST['submit'] ) ) {
                $this->client_details_validation( $_POST['client_id'], $_POST['client_password'], $_POST['program_id'],
                                                  $_POST['url_api'], $_POST['order_timestamp_limit'], $_POST['open_widget'], $_POST['min_width'],
                                                  $_POST['widget_below'] );
            ...
            $this->client_details_form( $clientId, $clientPassword, $programId, $bonusId, $source, $orderTimestampLimit,
                                        $shippingCost, $expanded, $minWidth, $widgetBelow, $animation );
        }
        ...
        public function init_starbonus_redirect()
        {
            ...
            add_rewrite_rule( '^starbonus/([^/]+)(?:/(.*))?$',
                              'index.php?&starbonus_click_id=$matches[1]&starbonus_url_domain=$matches[2]', 'top' );
        }
        ...
        public function getStarbonusApi()
        {
            if ( $this->starbonusApi === null ) {
                ...
                $credentials = new \OAuth\Common\Consumer\Credentials( get_option( 'starbonus_client_id' ),
                                                                       get_option( 'starbonus_client_password' ), null );
